...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		// It does not make sense to multiply matrices when we are returning a list!
		// i = row; j = column; k=element iterator
		int numVertices = this.getNumVertices();
		int i = v;
		List<Integer> returnValue = new ArrayList<Integer>(numVertices);
...
//				dot_prod += adjMatrix[i][k] * adjMatrix[k][j];
			}
		}
